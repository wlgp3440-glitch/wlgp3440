...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 900px) { .images-grid { grid-template-columns: repeat(2, 1fr); } .preview-grid { grid-template-columns: repeat(2, 1fr); } }
    </style>
</head>
<body>
<div class="container">
    ...
    <div class="section">
        ...
        <div class="input-group">
            <label>내용 (5줄)</label>
            <textarea id="contentText" placeholder="줄1&#10;줄2&#10;줄3&#10;줄4&#10;줄5"></textarea>
        </div>
    ...
    <div class="section results" id="results">
        ...
        <div class="full-preview" id="fullPreview">
            ...
            <img id="previewImage">
            <p id="previewText"></p>
            <button class="btn download-btn" onclick="downloadAll()">⬇️ 모두 다운로드</button>
        </div>
    </div>
</div>
